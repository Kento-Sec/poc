...
def title():
    print("""
                           深信服_日志中心c.php远程命令执行漏洞
                      use: python3 深信服_日志中心c.php远程命令执行漏洞.py
                                 Author: kento-sec
    """)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 3:
        print(
            "[-]  参数错误！\neg1:>>>python3 深信服_日志中心c.php远程命令执行漏洞.py -u http://127.0.0.1\neg2:>>>python3 深信服_日志中心c.php远程命令执行漏洞.py -f ip.txt")
    elif args.url:
